...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC1     ------> ADC1_IN11
    */
    GPIO_InitStruct.Pin = IRSensor_Left_Pin|IRSensor_Right_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC1     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(GPIOC, IRSensor_Left_Pin|IRSensor_Right_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(MotorA_Encoder_Signal_2_GPIO_Port, MotorA_Encoder_Signal_2_Pin);

    HAL_GPIO_DeInit(MotorA_Encoder_Signal_1_GPIO_Port, MotorA_Encoder_Signal_1_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MotorB_Encoder_Signal_1_Pin|MotorB_Encoder_Signal_2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, STM32_RPI_TX_Pin|STM32_RPI_RX_Pin);
